...
fn _add_class(vtag: &mut VTag, class: impl Into<Classes>) {
...
pub fn _render_markdown(src: &str) -> Html {
    let mut elems = vec![];
    let mut spine = vec![];
                        ...
                        if let VNode::VTag(ref mut vtag) = r {
                                ...
                                .enumerate()
                            {
                                if let VNode::VTag(ref mut vtag) = c {
                                    match aligns[i] {
                                        Alignment::None => {}
                                        Alignment::Left => _add_class(vtag, "text-left"),
                                        Alignment::Center => _add_class(vtag, "text-center"),
                                        Alignment::Right => _add_class(vtag, "text-right"),
                                    }
                                }
                            }
                        }
